    ...
    sidebarPanel(
      ...
      conditionalPanel(
        ...
        conditionalPanel(
          ...
          selectInput(inputId = 'Statistic', 'Statistic:', choices = c('Pass Completions' = 'Cmp', 'Pass Attempts' = 'Pass_Att', 'Passing Yards' = 'Pass_Yds', 'Pass Interceptions' = 'Pass_Int', 'Rush Attempts' = 'Rush_Att', 'Rushing Yards' = 'Rush_Yds', 'Rushing Touchdowns' = 'Rush_Tds'), 
                      selected = 'Passing Yards')
        ),
        #Changes statistics if Position is RB, FB, or WR
        conditionalPanel(
          condition = "input.Pos == 'RB' | input.Pos == 'FB' | input.Pos == 'WR'",
          selectInput(inputId = 'Statistic', 'Statistic:', choices = c('Rush Attempts' = 'Rush_Att', 'Rushing Yards' = 'Rush_Yds', 'Rushing Touchdowns' = 'Rush_Tds', 'Receptions' = 'Rec', 'Receiving Yards' = 'Rec_Yds', 'Receiving Touchdowns' = 'Rec_Tds'), 
                      selected = 'Rushing Yards')
        ),
        #Changes statistics if Position is TE
        conditionalPanel(
          condition = "input.Pos == 'TE'",
          selectInput(inputId = 'Statistic', 'Statistic:', choices = c('Receptions' = 'Rec', 'Receiving Yards' = 'Rec_Yds', 'Receiving Touchdowns' = 'Rec_Tds'), 
      ...
      conditionalPanel(
        ...
        selectInput(inputId = 'P', 'Position:', choices = c('Safety' = 'S', 'Cornerback' = 'CB', 'Defensive End' = 'DE', 'Linebacker' = 'LB', 'Defensive Tackle' = 'NT'), 
                    selected = 'Cornerback'),
